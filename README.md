...
| [lsp](https://github.com/Zeioth/heirline-components.nvim/wiki/lsp%E2%80%90component) | Statusline component to display the currently loaded lsp servers, linters and formatters. Or their current load % if they haven't loaded yet. Similar to the plugin [noice.nvim](https://github.com/folke/noice.nvim). |
