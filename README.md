...
You can control the tabline from your keymappings using the [heirline-components.buffer](https://github.com/Zeioth/heirline-components.nvim/wiki/buffer) library.
