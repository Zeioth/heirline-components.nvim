...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.is_active }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = function() return require("heirline-components.status").condition.buffer_matches { buftype = { "terminal" } } end }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.is_macro_recording }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.is_hlsearch }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.is_statusline_showcmd }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.is_git_repo }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.git_changed }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.file_modified }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.file_read_only }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.has_diagnostics }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.has_filetype }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.aerial_available }
function M.aerial_available() return package.loaded["aerial"] end

--- A condition function if LSP is attached.
---@param bufnr table|integer a buffer number to check the condition for, a table with bufnr property, or nil to get the current buffer.
---@return boolean # whether or not LSP is attached.
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.lsp_attached }
function M.lsp_attached(bufnr)
  if type(bufnr) == "table" then bufnr = bufnr.bufnr end
  return package.loaded["heirline-components.lsp"]
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("heirline-components.status").condition.treesitter_available }
